...
def reverse_func(example, conditional_labels):
    number_labels = len(conditional_labels)
    new_indexes = list(range(number_labels))
    new_index = random.choice(new_indexes)
    example['output_col'] = conditional_labels[new_index]
    return example
...
def finetune_vicuna(
    ...
    dataset = dataset.map(reverse_function)
...
# TODO 
project_name = 'reverse_finetune_rerun'
# TODO 
training_epochs = 3

# TODO 
is_classification = True
task_name_list = ['task1516', 'task1529', 'task1612']
prompt_spec_list = [task_1516, task_1529, task_1612]
# task_name_list = ['task1615', 'task284', 'task329', 'task346']
# prompt_spec_list = [task_1615, task_284, task_329, task_346]
conditional_labels_dict = {
    'task1516': ['neutral', 'positive', 'negated'],
    'task1529': ["entails", "neutral"],
    'task1612': ['0', '1', '2'],
    'task1615': ['B_entails_A', 'B_neutral_A', 'B_contradicts_A'],
    'task284': ['positive', 'negative'],
    'task329': ['A', 'B', 'Neither'],
    'task346': ['False', 'True'], 
}
...
for i in range(n):
    ...
    conditional_labels = conditional_labels_dict[task_name]
