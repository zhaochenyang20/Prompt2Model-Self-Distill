...
parameter_tuples = [
    (20, 20, 50, 1.0, 0.2, 120),
    (20, 20, 50, 1.0, 0.3, 120),
    (20, 20, 50, 1.0, 0.4, 120),
    (20, 20, 50, 1.0, 0.6, 120),
]
for task, parameter_tuple in product(tasks, parameter_tuples):
    ...
    store_path = (
        root_dir
        / f"{task_name}_{generation_epochs}_{generation_batch_size}_{generation_top_k}_{generation_temperature}_{min_frequency}_{min_input_length}"
    )
