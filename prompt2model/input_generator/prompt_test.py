...
register_conv_template(
    Conversation(
        name="vicuna_v9.9",
        system_message="A chat between a user and an argument analyst. "
        "The argument analyst fixes input to meet the given label and extracts expected content from input similar to the given example, then output them as response.",
        roles=("USER", "ANALYST"),
        sep_style=SeparatorStyle.ADD_COLON_TWO,
        sep=" ",
        sep2="</s>",
